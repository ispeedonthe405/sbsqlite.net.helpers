...
{
    public class DatastoreWithCollection<T> where T : class, new()
    {
        ///////////////////////////////////////////////////////////
        #region Fields
        ...
        public ObservableCollection<T> Collection { get => _Collection; }
        ...
        public DatastoreWithCollection(string folder, string name)
        {
            try
            {
                Name = name;
        ...
        public DatastoreWithCollection(string folder, string[]? subfolders, string name)
        {
            try
            {
                Name = name;
